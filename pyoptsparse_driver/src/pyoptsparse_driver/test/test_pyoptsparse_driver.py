...
class OptimizationUnconstrained(Assembly):
    """Unconstrained optimization of the Paraboloid with SNOPT."""
...
class ArrayOpt(Assembly):
    """Constrained optimization of the ArrayParaboloid with SNOPT."""
...
class pyOptSparseDriverTestCase(unittest.TestCase):
...
#        assert_rel_error(self, self.top.paraboloid.x[1], -7.824225, 0.01)
    ...
    # TODO - pyoptsparse doesn't support integer design vars. (KTM)
