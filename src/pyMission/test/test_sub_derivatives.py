...
class Testcase_pyMission_derivs(unittest.TestCase):
    ...
    def run_model(self):
        ...
        self.model.driver.gradient_options.lin_solver = "linear_gs"
        self.model.driver.gradient_options.maxiter = 100
        self.model.driver.gradient_options.derivative_direction = 'adjoint'
